            ...
            <div class="lmh-home-root-menu-container">
                ...
                <?php 
                    ...
                    while($query->have_posts()){
                        $query->the_post();
                        echo sprintf("<li class='menu-item'><a class='section-link scrollable' data-destination=\"#front-page-section-%d\">%s</a></li>",
                            get_the_ID(),
                            get_the_title()
                        );
                    }
                    echo "<li class='menu-item'><a class='section-link scrollable' data-destination=\"#blogroll\">Blog</a></li>";
                ?>
                </ul>
            </div>
        </div>
